...
//ncm_enable
static unsigned int g_ncm_enable = 0;
module_param(g_ncm_enable, uint, S_IRUGO|S_IWUSR);
MODULE_PARM_DESC(g_ncm_enable, "NCM Enable");
...
static int camera_proc_uninit(void) 
{
	remove_proc_entry("usb_camera", NULL);
	return 0;
}
