TARGET_ARCH :=arm
TARGET_CROSS :=arm-hisiv600-linux-
LINUX_CODE_PATH := /data/$(shell whoami)/work_space/hi3559v100/Hi3559V100R003_SDK_V2.0.3.0/osdrv/opensource/linux/linux-3.18.y
...
obj-$(CONFIG_PHY_HISI_USB3)     += phy/phy_hi3519v101/
...
default:	
	...
	@cp $(PWD)/phy/phy_hi3519v101/*.ko $(KO_OUT_DIR)
