...
#LINUX_CODE_PATH := /data/hgy/cooper_linux_sdk_2.0_cv2x_cv5x_cv7x/cv_common_trunk/cooper_linux_sdk_2.0_cv2x_cv5x_cv7x/ambarella/kernel/linux-5.15
LINUX_CODE_PATH := /mnt/data/docker_cv72_2.5/ljw/cv72/cv72_trunk_2.5/ambarella/kernel/linux-5.15
...
#LINUX_OBJ_PATH := /data/hgy/cooper_linux_sdk_2.0_cv2x_cv5x_cv7x/cv_common_trunk/cooper_linux_sdk_2.0_cv2x_cv5x_cv7x/ambarella/out/amba_out/cv5_timn/objects/kernel/linux-5.15
LINUX_OBJ_PATH := /mnt/data/docker_cv72_2.5/ljw/cv72/cv72_trunk_2.5/ambarella/out/amba_out/cv72_gage/objects/kernel/linux-5.15
...
obj-$(CONFIG_TYPEC_HUSB311)			+= udc/cdns3_cv5/tcpm/
...
default:
	...
	#@cp $(PWD)/udc/cdns3_cv5/tcpm/*.ko $(KO_OUT_DIR)
