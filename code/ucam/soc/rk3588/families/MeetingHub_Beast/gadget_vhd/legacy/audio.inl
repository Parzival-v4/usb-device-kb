...
#else
#ifndef CONFIG_GADGET_UAC1_LEGACY_VHD
#include "u_uac1.h"
...
#else /* CONFIG_GADGET_UAC1_LEGACY_VHD */
...
#endif /* CONFIG_GADGET_UAC1_LEGACY_VHD */
#endif
...
#ifdef CONFIG_GADGET_UAC1_LEGACY_VHD
...
static int audio_bind(struct usb_composite_dev *cdev)
{
	...
	uac2_opts->p_srates[0] = p_srate;
	uac2_opts->p_ssize = p_ssize;
	uac2_opts->c_chmask = c_chmask;
	uac2_opts->c_srates[0] = c_srate;
