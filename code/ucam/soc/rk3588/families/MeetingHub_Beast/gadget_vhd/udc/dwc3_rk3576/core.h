...
#define DWC3_ZLP_BUF_SIZE	1024	/* size of a superspeed bulk *//*vhd gadget*/
#define DWC3_EP0_SETUP_SIZE	512
#define DWC3_EP0_BOUNCE_SIZE	512 /*vhd gadget*/
...
#define DWC3_DEVICE_EVENT_EOPF			6 //vhd gadget
...
#define DWC3_DCFG_LOWSPEED	(2 << 0) //vhd gadget
...
/* These apply for core versions 1.94a and later */ //vhd gadget
...
#define DWC3_EVENT_PRAM_MAX_SOFFN			0x3fff //vhd gadget
#define DWC3_EVENT_PRAM_SOFFN_MASK			0x3fff //vhd gadget
...
#define DWC3_DSTS_LOWSPEED		(2 << 0)//vhd gadget
...
struct dwc3_ep {
	...
	spinlock_t		lock;//vhd gadget
	void __iomem		*regs;

	struct dwc3_trb		*trb_pool;
	dma_addr_t		trb_pool_dma;
	const struct usb_ss_ep_comp_descriptor *comp_desc;//vhd_gadget
	struct dwc3		*dwc;
...
#define DWC3_EP_BUSY		BIT(4) //vhd gadget
#define DWC3_EP_PENDING_REQUEST		BIT(5)
#define DWC3_EP_DELAY_START		BIT(6)
#define DWC3_EP_WAIT_TRANSFER_COMPLETE	BIT(7)
#define DWC3_EP_UPDATE          BIT(7) //vhd gadget
...
#define DWC3_EP0_DIR_IN			BIT(31)
	...
	u8			type;
	u8			resource_index;
	u32			allocated_requests;//vhd gadget
	u32			queued_requests;//vhd gadget
	u32			frame_number;
	u32			interval;
...
#define DWC3_REQUEST_STATUS_UNKNOWN		-1
	...
	unsigned int		started:1;//vhd gadget
	unsigned                zero:1;//vhd gadget
};
...
struct dwc3 {
	...
	struct usb_ctrlrequest	*ctrl_req;//vhd gadget
	struct dwc3_trb		*ep0_trb;
//	void			*bounce;//vhd gadget
	void			*ep0_bounce;
	void			*zlp_buf;
	void			*scratchbuf;
	u8			*setup_buf;
	dma_addr_t		ctrl_req_addr;//vhd gadget
	dma_addr_t		ep0_trb_addr;
//	dma_addr_t		bounce_addr;//vhd gadget
	dma_addr_t		ep0_bounce_addr;//vhd gadget
...
//	struct usb_gadget	*gadget;//vhd gadget
	struct usb_gadget	gadget;//vhd gadget
...
#ifndef CHIP_RV1126
    struct timer_list reconnect_timer;//vhd gadget
#endif
...
/****************vhd gadget end**********************************/
	...
	unsigned		eps_new_init:1;//vhd gadget
...
/* check whether we are on the DWC_usb31 core */ //vhd gadget
...
//void dwc3_remove_requests(struct dwc3 *dwc, struct dwc3_ep *dep, int status); //vhd gadget
#else
