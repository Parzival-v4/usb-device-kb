CROSS_COMPILE := /opt/sigmastar/gcc-10.2.1-20210303-sigmastar-glibc-x86_64_aarch64-linux-gnu/bin/aarch64-linux-gnu-sigmastar-10.2.1-
TARGET_ARCH := arm64
TARGET_CROSS := $(CROSS_COMPILE)
#LINUX_CODE_PATH := /data/$(shell whoami)/work_space/kernel/kernel_ssc369
LINUX_CODE_PATH := /data/qhc/sigmastar/ssc369g_sdk0430/kernel
...
CONFIG_SSTAR_USB_DWC3_OF_SIMPLE=m
export CONFIG_SSTAR_USB_DWC3_OF_SIMPLE
#########################RNDIS#############################
...
obj-$(CONFIG_USB_DWC3)				+= udc/dwc3_ssc369/
#obj-$(CONFIG_USB_GADGET_SSTAR_DEVICE)	+= udc/usb20_ssc333/
obj-$(CONFIG_SS_USB3_PHY)  			+= phy/phy_ssc369/
#obj-$(CONFIG_VIDEOBUF2_CORE)		+= v4l2-core/v4l2-core_linux-4.9/
#obj-$(CONFIG_VIDEOBUF2_CORE)		+= v4l2-core/v4l2-core_ssc369/
...
default:
	...
	#@cp $(PWD)/v4l2-core/v4l2-core_ssc369/*.ko $(KO_OUT_DIR)
	@cp $(PWD)/phy/phy_ssc369/*.ko $(KO_OUT_DIR)
	@cp $(PWD)/udc/*.ko $(KO_OUT_DIR)
	@cp $(PWD)/udc/dwc3_ssc369/*.ko $(KO_OUT_DIR)
	#@cp $(PWD)/udc/usb20_ssc333/*.ko $(KO_OUT_DIR)
	#@cp $(PWD)/udc/common/*.ko $(KO_OUT_DIR)
	$(TARGET_STRIP) $(KO_OUT_DIR)/*.ko --strip-unneeded
	@cp $(KO_OUT_DIR)/*.ko ~/nfs/ssc369_ko/
