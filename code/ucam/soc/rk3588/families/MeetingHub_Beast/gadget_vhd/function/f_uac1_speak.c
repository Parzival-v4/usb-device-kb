...
#define UAC_DT_TOTAL_LENGTH (UAC_DT_AC_HEADER_LENGTH \
	...
	+ UAC_DT_FEATURE_UNIT_SIZE(0) + UAC_DT_FEATURE_UNIT_SIZE(0))
...
static struct  uac_feature_unit_descriptor_0 feature_unit_mic_desc = {
...
static struct  uac_feature_unit_descriptor_0 feature_unit_spk_desc = {
        .bLength =      UAC_DT_FEATURE_UNIT_SIZE(0),     
        .bDescriptorType = USB_DT_CS_INTERFACE, 
        .bDescriptorSubtype     = UAC_FEATURE_UNIT, 
        ...
        .bControlSize = 1,     
        .bmaControls[0] = (UAC_FU_MUTE | UAC_FU_VOLUME),   
        //.bmaControls[1] = UAC_FU_VOLUME,
        //.bmaControls[2] = UAC_FU_VOLUME,
        .iFeature = 0, 
};
