...
#define UAC_EVENT_LAST			(V4L2_EVENT_PRIVATE_START + 7)

#define UAC_EVENT_STREAMON_SPEAK		(V4L2_EVENT_PRIVATE_START + 8)
#define UAC_EVENT_STREAMOFF_SPEAK		(V4L2_EVENT_PRIVATE_START + 9)
...
#define UAC_EVENT_SPEAK_LAST	(V4L2_EVENT_PRIVATE_START + 13)
