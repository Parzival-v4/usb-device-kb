TARGET_ARCH :=arm
TARGET_CROSS :=arm-himix100-linux-
LINUX_CODE_PATH := /data/$(shell whoami)/work_space/kernel/linux-4.9.y_hi3516ev300_sdk010
#LINUX_CODE_PATH := /home/$(shell whoami)/work_space/kernel/linux-4.9.y_hi3516ev300_sdk012
...
obj-$(CONFIG_PHY_HISI_XVP_USB2) += phy/phy_hi3516ev300/
...
default:
	...
	@cp $(PWD)/phy/phy_hi3516ev300/hibvt/*.ko $(KO_OUT_DIR)
