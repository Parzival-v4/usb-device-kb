CROSS_COMPILE := /opt/sigmastar/gcc-sigmastar-9.1.0-2019.11-x86_64_arm-linux-gnueabihf/bin/arm-linux-gnueabihf-9.1.0-
TARGET_ARCH := arm
TARGET_CROSS := $(CROSS_COMPILE)
#LINUX_CODE_PATH := /data/$(shell whoami)/work_space/kernel/kernel_ssc9381
#LINUX_CODE_PATH := /data/$(shell whoami)/sigmastar/JX1700US_SDK0106/kernel
LINUX_CODE_PATH :=/data/$(shell whoami)/work_space/kernel/kernel_ssc9381_sdk_0510
...
obj-$(CONFIG_PHY_SSTAR_INFINITY6E)  += phy/phy_ssc9381/
...
default:
	...
	@cp $(PWD)/phy/phy_ssc9381/*.ko $(KO_OUT_DIR)
