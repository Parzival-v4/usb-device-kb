...
static int uac_pcm_hardware_resize(struct uac_device *uac_dev)
{
	...
	period_bytes_max_tmp = (c_srate * c_ssize * num_channels(c_chmask)) * MAX_PERIODS_MS / 1000;
			       ...
			       struct snd_pcm_hw_params *hw_params)
{
	...
	//printk("prm->period_size = %d,prm->dma_bytes = %d\n",prm->period_size,prm->dma_bytes);
	return err;
}
