 ...
 * @FilePath    : \lib_ucam\ucam\include\ucam\uvc\uvc_config.h
 * @Description : 
 */ 
...
#define	UVC_FORMAT_3FPS						  	  (uint32_t)(0x0032DCD5)
...
#define USB_EP_ISO_PKT_SIZE(count, pkt_size)	(uint16_t)((pkt_size & 0x7FF) | ((count - 1) << 11))
...
typedef enum
{
	...
	UVC_YUV_FORMAT_INDEX_160x120 ,
	UVC_YUV_FORMAT_INDEX_176x144 ,
	...
	UVC_MJPEG_FORMAT_INDEX_160x120 ,
	UVC_MJPEG_FORMAT_INDEX_176x144 ,
	...
	UVC_MJPEG_FORMAT_INDEX_480x272 ,
	...
	UVC110_H264_FORMAT_INDEX_160x120 ,
	UVC110_H264_FORMAT_INDEX_176x144 ,
	...
	UVC110_H264_FORMAT_INDEX_480x272 ,
	...
	UVC_H264_FORMAT2_INDEX_480x272 ,
...
#define UVC_ENTITY_ID_PROCESSING_UNIT_DEF 		3
...
#define UVC_ENTITY_ID_XU_PTZ         			0x0F
#define UVC_ENTITY_ID_XU_CUSTOM_COMMANDS    	0x10
#define UVC_ENTITY_ID_XU_MENU    				0x13
#define UVC_ENTITY_ID_XU_WINDOWS_HELLO    		0x2C
...
/****************************Windows hello定义********************************************/
#define V4L2_PIX_FMT_L8_IR     v4l2_fourcc('I', 'R', 'L', '8') /* 8 位仅限亮度的帧 */
//00000032-0002-0010-8000-00aa00389b71
#define UVC_GUID_FORMAT_L8_IR \
{ 0x32,  0x00,  0x00,  0x00, 0x02, 0x00, 0x10, 0x00, \
0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71}

#define V4L2_PIX_FMT_L16_IR     v4l2_fourcc('I', 'R', '1', '6') /* 16 位仅限亮度的帧 */
//00000051-0002-0010-8000-00aa00389b71
#define UVC_GUID_FORMAT_L16_IR \
{ 0x51,  0x00,  0x00,  0x00, 0x02, 0x00, 0x10, 0x00, \
0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71}

#define V4L2_PIX_FMT_MJPEG_IR     v4l2_fourcc('I', 'R', 'M', 'J') /* 压缩的 MJPEG 仅限亮度的帧 */
//47504a4d-0002-0010-8000-00aa00389b71
#define UVC_GUID_FORMAT_MJPEG_IR \
{ 0x4d,  0x4a,  0x50,  0x47, 0x02, 0x00, 0x10, 0x00, \
0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71}

//{0F3F95DC-2632-4C4E-92C9-A04782F43BC8}
#define UVC_GUID_XU_WINDOWS_HELLO \
...
#define UVC_GUID_XUCONTROL_MENU \
{ 0x8c, 0xcd, 0x1d, 0x66, 0xB0, 0xAD, 0x44, 0xB3, \
0x8C, 0xB4, 0xD3, 0x35, 0x11, 0x5F, 0xC1, 0x8C}
...
// {9D33BBE7-E619-435C-8FAC-528EECCCBCA4}
#define UVC_GUID_XUCONTROL_PTZ \
{ 0xe7, 0xbb, 0x33, 0x9d, 0x19, 0xe6, 0x5C, 0x43, \
0x8f, 0xac, 0x52, 0x8e, 0xec, 0xcc, 0xbc, 0xa4}
...
#define UVC_PU_GAIN_CONTROL_SUPPORTED                           1
...
#define UVC_PU_GAMMA_CONTROL_SUPPORTED                          1
...
#define UVC_CT_FOCUS_RELATIVE_CONTROL_SUPPORTED         		1
#define UVC_CT_FOCUS_AUTO_CONTROL_SUPPORTED             		1
#define UVC_CT_IRIS_ABSOLUTE_CONTROL_SUPPORTED          		0
#define UVC_CT_IRIS_RELATIVE_CONTROL_SUPPORTED          		0
#define UVC_CT_ZOOM_ABSOLUTE_CONTROL_SUPPORTED          		1
#define UVC_CT_ZOOM_RELATIVE_CONTROL_SUPPORTED          		1
#define UVC_CT_PANTILT_ABSOLUTE_CONTROL_SUPPORTED       		1
#define UVC_CT_PANTILT_RELATIVE_CONTROL_SUPPORTED       		1
...
#define UVC_COPY_DESCRIPTORS_FROM_BUF_TO_KERNEL(kmem, mem, dst, buf, buf_len) \
	do { \
		int i; \
		for (i = 0; i < buf_len;) { \
			const struct usb_descriptor_header * desc_header = (const struct usb_descriptor_header *)(buf + i); \
...
#define DESC_BUF_MAX_LENGTH 16384 /* offset for mmap() must be page aligned */

#define UVC_CLOCK_FREQUENCY 1000000
